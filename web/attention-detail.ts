...
function componentBlock(component: AttentionBreakdownComponentView): HTMLElement {
  return el(
    ...
    el(
      ...
      el("dt", {}, "翌年度繰越額"), el("dd", {}, formatYenExact(component.amounts.carryoverYen)),
      el("dt", {}, "不用額"), el("dd", {}, formatYenExact(component.amounts.unusedYen)),
  ...
  return el(
    ...
    el(
      ...
      el(
        ...
        el("dt", {}, "翌年度繰越額"), el("dd", {}, formatYenExact(item.amounts.carryoverYen)),
        el("dt", {}, "不用額"), el("dd", {}, formatYenExact(item.amounts.unusedYen)),
        el("dt", {}, "年度内未執行額"), el("dd", {}, formatYenExact(item.amounts.yearEndUnexecutedYen)),
      ),
    ),
    el(
      "section",
